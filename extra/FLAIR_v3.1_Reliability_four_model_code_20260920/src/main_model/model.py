...
class GCNConv(MessagePassing):
    ...
    def __init__(self, emb_dim, out_dim=None, aggr = "add", **kwargs):
        kwargs.setdefault('aggr', aggr)
        self.aggr = aggr
...
class GATConv(MessagePassing):
    def __init__(self, emb_dim, out_dim=None, heads=2, negative_slope=0.2, aggr = "add"):
...
class GNN_graphpred(torch.nn.Module):
    ...
    def from_pretrained(self, model_file, map_location='cpu'):
        ...
        self.gnn.load_state_dict(torch.load(model_file, map_location=map_location, weights_only=True))
